<?php
	...
	if(!defined('SERVIDOR')) define('SERVIDOR', 'mysql.fkp.com.br');
	if(!defined('USUARIO')) define('USUARIO', 'fkp01');
	if(!defined('SENHA')) define('SENHA', '1f5d8r5b3n5f');
	if(!defined('BANCO')) define('BANCO', 'fkp01');
	
	#INICIO CONFIGURA��O DO TEMA
	...
	if(!defined('NOME_DO_CLIENTE')) define('NOME_DO_CLIENTE', 'Federa��o de Karat� Paulista');
	if(!defined('CAMINHO_SITE_GERAL')) define('CAMINHO_SITE_GERAL', 'http://www.fkp.com.br/'); // N�o esque�a a barra / no final da url.
