...
AND noticia.ID = '%d'
LIMIT 1",
FiltrarCampos(mysql_real_escape_string(utf8_decode($IDNoticia)))
);
...
while ($row = mysql_fetch_array($ResultadoNoticia)){			
	...
	$BuscaMostrarNoticias[$nCount]["Titulo"         ] = trim($row[2]);
	$BuscaMostrarNoticias[$nCount]["TextoConteudo"  ] = trim($row[3]);
	$BuscaMostrarNoticias[$nCount]["PastaDeConteudo"] = trim($row[4]);
	$BuscaMostrarNoticias[$nCount]["ImagemDestaque" ] = trim($row[5]);
	$BuscaMostrarNoticias[$nCount]["Chamada"        ] = trim($row[6]);
$nCount++;
}
mysql_Free_Result($ResultadoNoticia);
#FIM SELECT CAMPOS PREENCHIDOS

$PastaDeConteudo = $BuscaMostrarNoticias[1]["PastaDeConteudo"];
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" class="TextoVerdana12B">Aten&ccedil;&atilde;o, voc&ecirc; ir&aacute; alterar o conte&uacute;do da not&iacute;cia: <?php echo utf8_encode($BuscaMostrarNoticias[1]["Titulo"]); ?></td>
  </tr>
  <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="TituloPrincipal" type="text" class="TextFields" id="TituloPrincipal" maxlength="110" style="width:660px;" value="<?php echo utf8_encode(htmlentities($BuscaMostrarNoticias[1]["Titulo"])); ?>" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="10" align="left"><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><textarea name="Chamada" rows="4" class="TextFields" id="Chamada" style="width:660px; overflow:auto" onKeyUp="LimitarTextArea(Chamada,122);"><?php echo utf8_encode($BuscaMostrarNoticias[1]["Chamada"]); ?></textarea></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="ImagemDestaque" type="text" class="TextFields" id="ImagemDestaque" style="width:660px;" onclick="this.select();" value="<?php echo utf8_encode($BuscaMostrarNoticias[1]["ImagemDestaque"]); ?>" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                      ...
                      <tr>
                        <td><div id="DivConteudoBBCode" style="display:block">
                            <table border="0" cellspacing="0" cellpadding="0" class="BordaBBCode">
                              ...
                              <tr>
                                <td height="20"><textarea name="TextAreaBBCode" rows="20" cols="91" class="TextAreaBBCode" id="TextAreaBBCode"><?php echo utf8_encode($BuscaMostrarNoticias[1]["TextoConteudo"]); ?></textarea></td>
                              </tr>
                            </table>
                          </div></td>
                      </tr>
                    ...
                    <tr>
                      <td><input type="button" class="BotaoPadrao"
                                     ...
                                     if (ValidarCamposNulos(FormCadastro.TextAreaBBCode)){
									  EnviarFormularios('Ferramentas/Noticias/AcaoEditarNoticia.php','DivResultadosInternos','CampoTituloPrincipal='+encodeURIComponent(document.getElementById('TituloPrincipal').value)
                                      +'&amp;CampoChamada='+encodeURIComponent(document.getElementById('Chamada').value)
                                      +'&amp;CampoTextAreaBBCode='+encodeURIComponent(document.getElementById('TextAreaBBCode').value)
                                      +'&amp;CampoImagemDestaque='+encodeURIComponent(document.getElementById('ImagemDestaque').value)
                                      +'&amp;CampoID='+encodeURIComponent('<?php echo $BuscaMostrarNoticias[1]["ID"]; ?>'));                                      
                                    }}}" value="Enviar" /></td>
                      <td><input type="button" class="BotaoPadrao" 
