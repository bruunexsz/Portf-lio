...
$PastaDeConteudoDoDestaque = "".strftime("%Y%m%d%H%M%S")."";
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" class="TextoVerdana12B"> Aten&ccedil;&atilde;o, voc&ecirc; ir&aacute; cadastrar um novo destaque no sistema, preencha os campos abaixo e clique em enviar.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><!--/INICIO FORM CADASTRO DESTAQUES/-->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><!--//-->
            <form id="FormCadastrarNovoDestaque" name="FormCadastrarNovoDestaque" action="CadastrarNooDestaque.php" method="post" enctype="multipart/form-data" class="FormsSemBordas" onsubmit="return false;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input type="hidden" value="" id="ControleEnvioFotos" />
                          ...
                          <input name="TituloDoDestaque" type="text" class="TextFields" id="TituloDoDestaque" style="width:660px;" maxlength="47" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="3">
                      ...
                      <tr>
                        <td height="20"><input name="LinkDoDestaque" type="text" class="TextFields" id="LinkDoDestaque" style="width:660px;" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                    ...
                    <tr>
                      <td height="20"><textarea name="ResumoDoDestaque" rows="7" class="TextFields" id="ResumoDoDestaque" style="width:660px;" onKeyUp="LimitarTextArea(ResumoDoDestaque,97);"></textarea></td>
                    </tr>
                </table></td>
                </tr>
                <tr>
