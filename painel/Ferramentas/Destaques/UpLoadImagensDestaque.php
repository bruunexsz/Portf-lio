...
if (!isset($PastaDeConteudoDoDestaque)) $PastaDeConteudoDoDestaque = '';
if (!isset($Controle)) $Controle = '';
if($PastaDeConteudoDoDestaque != '' && $Controle != ''){
...
#NO AR
$PastaACriar = CAMINHO_RELATIVO_IMAGENS_DESTAQUES.''.$PastaDeConteudoDoDestaque."/";
...
// Settings
	...
	$max_file_size_in_bytes = 147483647; // 2GB in bytes
	$extension_whitelist = array("jpg", "swf");	// Allowed file extensions
...
// Validate file extension
	...
	if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$file_name)) {
		...
		$SQLInserirImagens = sprintf("INSERT INTO cadastroimagensdestaques(
								ID,									
							...
							FiltrarCampos(mysql_real_escape_string(utf8_decode($PastaDeConteudoDoDestaque)))
							);
		#echo $cSQL;
