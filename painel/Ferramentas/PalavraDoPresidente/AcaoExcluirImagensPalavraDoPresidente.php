...
$TotalAExcluir = "OR cadastroimagenspresidente.ID = '".FiltrarCampos($ArrayParaSeparar[$i])."' ";	

$SelectImagens = "SELECT cadastroimagenspresidente.ID,
...
WHERE cadastroimagenspresidente.ID  = ''
  ".$TotalAExcluir."";
...
$PastaDoArquivo = CAMINHO_RELATIVO_IMAGENS_PALAVRA_DO_PRESIDENTE.$CampoPastaDeConteudo;
$ArquivoASerApagado = CAMINHO_RELATIVO_IMAGENS_PALAVRA_DO_PRESIDENTE."".$CampoPastaDeConteudo."/".$BuscaMostrarImagensParaExclusao[1]["ImagemConteudo"];
#echo $ArquivoASerApagado;
	...
	$SqlDeleteImagens = "DELETE FROM ".BANCO.".cadastroimagenspresidente
			  WHERE cadastroimagenspresidente.ID = ''
			  ".$TotalAExcluir."
			  ";
	...
	echo "<script>AlterarConteudo('Ferramentas/PalavraDoPresidente/InserirImagens.php','DivInserirImagem','CampoPastaDeConteudo=".$CampoPastaDeConteudo."');</script>";
