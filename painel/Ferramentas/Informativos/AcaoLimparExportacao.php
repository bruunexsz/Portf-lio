...
$UpdateQtdUsuariosExportados = "UPDATE ".BANCO.".exportarusuariosnewsletter 
			SET exportarusuariosnewsletter.IDUltimoUsuario = 0,
				exportarusuariosnewsletter.QuantidadeExportado = 0
...
$Msg = utf8_encode("Contador zerado com sucesso!");
