				...
				echo '<table border="0" cellpadding="0" cellspacing="0">';
						...
						for($i=1;$i<=count($BuscaMostrarImagensThumbs);$i++){
							...
							$atual = 0;
								...
								$CaminhoImagensThumbs = "../../../Img/ConteudoPublicidade/";																
								$CaminhoDaImagem = $CaminhoImagensThumbs."".$CampoPastaDeConteudo."/".$BuscaMostrarImagensThumbs[$i]["ImagemConteudo"];
								$CaminhoDaImagemInsert = CAMINHO_IMAGENS_PUBLICIDADE.''.$CampoPastaDeConteudo.'/'.$BuscaMostrarImagensThumbs[$i]["ImagemConteudo"];
								$CaminhoDaImagemLink = substr(CAMINHO_SITE_GERAL, 7)."Img/ConteudoPublicidade/".$CampoPastaDeConteudo."/".$BuscaMostrarImagensThumbs[$i]["ImagemConteudo"];
								?>
        <table border="0" cellspacing="0" cellpadding="0" id="<?php echo $BuscaMostrarImagensThumbs[$i]["ID"] ?>">
          <tr>
            <td><table border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#FFFFFF" id="<?php echo $BuscaMostrarImagensThumbs[$i]["ID"]."Publicidade" ?>">
                <tr>
                  <td><table  border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
                      <tr>
                        <td bgcolor="#FFFFFF"><img src="Ferramentas/Publicidade/MostrarThumbs.php?Imagem=<?php echo $CaminhoDaImagem; ?>" border="0" /></td>
                      </tr>
                    </table></td>
                </tr>
              </table></td>
  ...
  <tr>
    <td><table width="670" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="right"><input type="button" class="BotaoPadrao" value="Excluir imagens selecionadas" onClick="ConfirmacaoExclusaoPorCheckBox('Ferramentas/Publicidade/AcaoExcluirImagensPublicidade.php','DivInserirImagem','IDImagens='+encodeURIComponent(document.getElementById('ValoresCheckbox').value)+'&CampoPastaDeConteudo='+encodeURIComponent('<?php echo $CampoPastaDeConteudo;  ?>'),'ValoresCheckbox');"/></td>
        </tr>
        <tr>
          <td class="TextoVerdana12A" height="25" valign="middle"></td>
...
<script>ValidarControleImagensPublicidade('<?php echo mysql_num_rows($ResultadoImagens); ?>');</script>
