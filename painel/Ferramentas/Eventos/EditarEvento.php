...
$SelectEvento = sprintf("SELECT cadastroevento.ID,
	...
	cadastroevento.CartazDoEvento
FROM ".BANCO.".cadastroevento 
WHERE cadastroevento.ID  = '%d'
LIMIT 1",
FiltrarCampos(mysql_real_escape_string(utf8_decode($IDEvento)))
);
...
while ($row = mysql_fetch_array($ResultadoEvento)){			
	...
	$BuscaMostrarEventos[$nCount]["CartazDoEvento"          ] = trim($row[10]);
$nCount++;
}
mysql_Free_Result($ResultadoEvento);

$PastaDeConteudo = $BuscaMostrarEventos[1]["PastaDeConteudoDoEvento"];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" class="TextoVerdana12B">Aten&ccedil;&atilde;o, voc&ecirc; ir&aacute; editar o conte&uacute;do do evento: <?php echo utf8_encode($BuscaMostrarEventos[1]["TituloDoEvento"]); ?></td>
  </tr>
  <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      <tr>
                        ...
                        <td width="10" class="TextoComum">&nbsp;</td>
                      ...
                      <tr>
                        <td class="TextoComum"><select name="DiaDoEvento" id="DiaDoEvento" class="TextFields">
                            ...
                            <?php if(substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),0,2) != '00'){ ?>
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),0,2); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),0,2); ?></option>
                            <option value="">--</option>
                            <?php } ?>
                          ...
                          <select name="MesDoEvento" id="MesDoEvento" class="TextFields">
                            ...
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),3,2); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),3,2); ?></option>
                            <option value="">--</option>
                            <option value="01">01</option>
                            <option value="02">02</option>
                            <option value="03">03</option>
                          ...
                          <select name="AnoDoEvento" id="AnoDoEvento" class="TextFields">
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),6,4); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"]),6,4); ?></option>
                          </select></td>
                        <td width="10" align="center" class="TextoComum">-</td>
                        <td class="TextoComum"><select name="SeparadorEvento" id="SeparadorEvento" class="TextFields">
                            <option value=""></option>
                            <option value="<?php echo utf8_encode($BuscaMostrarEventos[1]["SeparadorData"]); ?>" selected="selected"><?php echo utf8_encode($BuscaMostrarEventos[1]["SeparadorData"]); ?></option>
                            <option value="">--</option>
                        ...
                        <td class="TextoComum"><select name="DiaDoEventoFinal" id="DiaDoEventoFinal" class="TextFields">
                            <option value="">Dia</option>
                            <?php if(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]) != FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"])){ ?>
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),0,2); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),0,2); ?></option>
                            <option value="">--</option>
                            <?php } ?>
                            <option value="01">01</option>
                            <option value="02">02</option>
                          ...
                          <select name="MesDoEventoFinal" id="MesDoEventoFinal" class="TextFields">
                            <option value="">M&ecirc;s</option>
                            <?php if(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]) != FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"])){ ?>
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),3,2); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),3,2); ?></option>
                            <option value="">--</option>
                            <?php } ?>
                            <option value="01">01</option>
                            <option value="02">02</option>
                          ...
                          <select name="AnoDoEventoFinal" id="AnoDoEventoFinal" class="TextFields">
                            ...
                            <?php if(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]) != FormataDataBanco($BuscaMostrarEventos[1]["DataInicial"])){ ?>
                            <option value="<?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),6,4); ?>" selected="selected"><?php echo substr(FormataDataBanco($BuscaMostrarEventos[1]["DataFinal"]),6,4); ?></option>
                            <option value="">--</option>
                            <?php } ?>
                ...
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="TituloDoEvento" type="text" class="TextFields" id="TituloDoEvento" value="<?php echo utf8_encode($BuscaMostrarEventos[1]["TituloDoEvento"]); ?>" maxlength="68" style="width:660px;" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="LocalDoEvento" type="text" class="TextFields" id="LocalDoEvento" value="<?php echo utf8_encode($BuscaMostrarEventos[1]["LocalDoEvento"]); ?>" maxlength="150" style="width:660px;" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="CartazDoEvento" type="text" class="TextFields" id="CartazDoEvento" onclick="this.select();" maxlength="150" style="width:660px;" value="<?php echo utf8_encode($BuscaMostrarEventos[1]["CartazDoEvento"]); ?>" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                            ...
                            <tr>
                              <td><div id="DivConteudoBBCode" style="display:block">
                                  <table border="0" cellspacing="0" cellpadding="0" class="BordaBBCode">
                                    ...
                                    <tr>
                                      <td height="20"><textarea name="TextAreaBBCode" rows="20" cols="91" class="TextAreaBBCode" id="TextAreaBBCode"><?php echo utf8_encode($BuscaMostrarEventos[1]["TextoConteudoDoEvento"]); ?></textarea></td>
                                    </tr>
                                  </table>
                                </div></td>
                            </tr>
                        ...
                        <td><input type="button" class="BotaoPadrao" 
                                    onClick="
                                     ...
                                     if (ValidarCamposNulos(FormCadastro.LocalDoEvento)){
                                      EnviarFormularios('Ferramentas/Eventos/AcaoEditarEvento.php','DivResultadosInternos','CampoTituloDoEvento='+encodeURIComponent(document.getElementById('TituloDoEvento').value)+'&CampoDiaDoEvento='+encodeURIComponent(document.getElementById('DiaDoEvento').value)+'&CampoMesDoEvento='+encodeURIComponent(document.getElementById('MesDoEvento').value)+'&CampoAnoDoEvento='+encodeURIComponent(document.getElementById('AnoDoEvento').value)+'&CampoDiaDoEventoFinal='+encodeURIComponent(document.getElementById('DiaDoEventoFinal').value)+'&CampoMesDoEventoFinal='+encodeURIComponent(document.getElementById('MesDoEventoFinal').value)+'&CampoAnoDoEventoFinal='+encodeURIComponent(document.getElementById('AnoDoEventoFinal').value)+'&CampoSeparadorEvento='+encodeURIComponent(document.getElementById('SeparadorEvento').value)+'&CampoLocalDoEvento='+encodeURIComponent(document.getElementById('LocalDoEvento').value)+'&CampoTextAreaBBCode='+encodeURIComponent(document.getElementById('TextAreaBBCode').value)+'&CampoCartazDoEvento='+encodeURIComponent(document.getElementById('CartazDoEvento').value)+'&CampoPastaDeConteudoDoEvento='+encodeURIComponent('<?php echo $PastaDeConteudo; ?>')+'&CampoIDEditarEvento='+encodeURIComponent('<?php echo $BuscaMostrarEventos[1]["ID"]; ?>'));
                                    }}}}" value="Enviar"></td>
                        <td><input type="button" class="BotaoPadrao" 
