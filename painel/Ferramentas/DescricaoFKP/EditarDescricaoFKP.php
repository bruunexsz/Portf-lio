...
$SelectDescricaoFKP = sprintf("SELECT cadastrodescricaofkp.ID,
	cadastrodescricaofkp.AtivacaoDaDescricao,
	cadastrodescricaofkp.TextoConteudoDaDescricao,
	cadastrodescricaofkp.PastaDeConteudoDaDescricao,
	cadastrodescricaofkp.UrlAmigavel
FROM ".BANCO.".cadastrodescricaofkp
WHERE cadastrodescricaofkp.AtivacaoDaDescricao = 1
AND cadastrodescricaofkp.ID = '%d'
LIMIT 1",
FiltrarCampos(mysql_real_escape_string(utf8_decode(1)))
);
$ResultadoDescricaoFKP = mysql_query($SelectDescricaoFKP) or die (mysql_error());
$nCount=1;
while ($row = mysql_fetch_array($ResultadoDescricaoFKP)){			
	$BuscaMostrarDescricaoFKP[$nCount]["ID"                        ] = trim($row[0]);
	$BuscaMostrarDescricaoFKP[$nCount]["AtivacaoDaDescricao"       ] = trim($row[1]);
	$BuscaMostrarDescricaoFKP[$nCount]["TextoConteudoDaDescricao"  ] = trim($row[2]);
	$BuscaMostrarDescricaoFKP[$nCount]["PastaDeConteudoDaDescricao"] = trim($row[3]);
	$BuscaMostrarDescricaoFKP[$nCount]["UrlAmigavel"               ] = trim($row[4]);
$nCount++;
}
mysql_Free_Result($ResultadoDescricaoFKP);
#FIM SELECT CAMPOS PREENCHIDOS

$PastaDeConteudo = $BuscaMostrarDescricaoFKP[1]["PastaDeConteudoDaDescricao"];
$CaminhoDaFerramenta = 'DescricaoFKP';
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" class="TextoVerdana12B"> Aten&ccedil;&atilde;o, voc&ecirc; ir&aacute; editar o conte&uacute;do da p&aacute;gina: Conhe&ccedil;a a Federa&ccedil;&atilde;o de Karat&ecirc; Paulista</td>
  </tr>
  <tr>
                  ...
                  <script type="text/javascript">			
                    var swfu;		
                        var settings = {
                            ...
                            upload_url: "Ferramentas/DescricaoFKP/UpLoadImagensDescricaoFKP.php?PastaDeConteudo=<?php echo $PastaDeConteudo; ?>&Controle=<?php echo $ResultadoControleUsuario['ID']; ?>",
                                  ...
                                  <tr>
                                    <td><div id="DivConteudoBBCode" style="display:block">
									  ...
									  <td align="center" valign="top" class="BotoesBBCode"><img src="Img/BBCode/youtube.gif" alt="Inserir imagem" width="20" height="20" border="0" style="cursor:pointer" onclick="BBCode('[youtube]','[/youtube]','TextAreaBBCode')"></td>
                                            ...
                                            <td align="center" valign="top"><img src="Img/BBCode/Separador.gif" width="6" height="18"></td>
                                                  <td align="center" valign="top" class="BotoesBBCode"><img src="Img/BBCode/visualizar.gif" alt="Inserir imagem" width="20" height="20" border="0" style="cursor:pointer" onclick="VisualizarConteudoBBCode(document.getElementById('TextAreaBBCode').value, 'DescricaoFKP','DivTituloVisualizacao','DivVisualizarConteudoBBCode','TabelaBBCodeConteudo');"></td>
                                                </tr>
                                              </table></td>
                                          </tr>
                                          <tr>
                                            <td height="20"><textarea name="TextAreaBBCode" rows="20" cols="91" class="TextAreaBBCode" id="TextAreaBBCode"><?php echo utf8_encode($BuscaMostrarDescricaoFKP[1]["TextoConteudoDaDescricao"]); ?></textarea></td>
                                          </tr>
                                        </table>
                                      </div></td>
                                  </tr>
              ...
              <tr>
                <td><input type="button" class="BotaoPadrao"
                                     onClick="if (ValidarCamposNulos(FormCadastrarNovoConteudo.TextAreaBBCode)){                                     
									  EnviarFormularios('Ferramentas/DescricaoFKP/AcaoEditarDescricaoFKP.php','DivResultadosInternos','CampoTextAreaBBCode='+encodeURIComponent(document.getElementById('TextAreaBBCode').value)+'&CampoIDDaPagina='+encodeURIComponent('<?php echo $BuscaMostrarDescricaoFKP[1]["ID"]; ?>'));
                                    }" value="Enviar"></td>
                <td><input type="button" class="BotaoPadrao" onclick="AlterarConteudo('Ferramentas/DescricaoFKP/ListarDescricaoFKP.php','DivResultadosInternos','');" value="Cancelar" /></td>
              </tr>
            </table></td>
        </tr>
        <tr>
