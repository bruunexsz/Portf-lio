...
$TotalAExcluir = "OR cadastroimagensdescricao.ID = '".FiltrarCampos($ArrayParaSeparar[$i])."' ";	

$SelectImagens = "SELECT cadastroimagensdescricao.ID,
...
WHERE cadastroimagensdescricao.ID  = ''
  ".$TotalAExcluir."";
...
$PastaDoArquivo = CAMINHO_RELATIVO_IMAGENS_DESCRICAO_FKP.$CampoPastaDeConteudo;
$ArquivoASerApagado = CAMINHO_RELATIVO_IMAGENS_DESCRICAO_FKP."".$CampoPastaDeConteudo."/".$BuscaMostrarImagensParaExclusao[1]["ImagemConteudo"];
#echo $ArquivoASerApagado;
	...
	$SqlDeleteImagens = "DELETE FROM ".BANCO.".cadastroimagensdescricao
			  WHERE cadastroimagensdescricao.ID = ''
			  ".$TotalAExcluir."
			  ";
	...
	echo "<script>AlterarConteudo('Ferramentas/DescricaoFKP/InserirImagens.php','DivInserirImagem','CampoPastaDeConteudo=".$CampoPastaDeConteudo."');</script>";
