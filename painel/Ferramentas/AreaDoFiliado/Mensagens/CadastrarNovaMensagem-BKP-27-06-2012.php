...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" class="TextoVerdana12B">Aten&ccedil;&atilde;o, voc&ecirc; ir&aacute; cadastrar uma nova mensagem, preencha os campos abaixo e clique em enviar.</td>
  </tr>
  <tr>
            ...
            <script type="text/javascript">			
                    var swfu;		
                        var settings = {
                            ...
                            file_types : "*.DOC;*.XLS",
                            file_types_description : "Documentos do Word e Excel",
                            file_upload_limit : 1000,
                            file_queue_limit : 10,
                            custom_settings : {
                                progressTarget : "fsUploadProgress",
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <td height="20"><input name="TituloDaMensagem" type="text" class="TextFields" id="TituloDaMensagem" maxlength="150" style="width:660px;" /></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                      ...
                      <tr>
                        <td><input type="button" class="BotaoPadrao" 
                                    ...
                                    if (ValidarCamposNulos(FormCadastrarNovaMensagem.TextAreaBBCode)){
                                      EnviarFormularios('Ferramentas/AreaDoFiliado/Mensagens/AcaoCadastrarNovaMensagem.php','DivResultadosInternos','CampoTituloDaMensagem='+encodeURIComponent(document.getElementById('TituloDaMensagem').value)+'&CampoTextAreaBBCode='+encodeURIComponent(document.getElementById('TextAreaBBCode').value)+'&CampoPastaDeConteudoDaMensagem='+encodeURIComponent('<?php echo $PastaDeConteudo; ?>'));
                                    }}" value="Enviar"></td>
                        <td><input type="button" class="BotaoPadrao" 
