...
for($i = 0; $i < count($ArrayParaSeparar); $i++) {
   ...
   $cSQL = sprintf("SELECT controlemensagemfiliado.ID,
	...
	mysql_real_escape_string(utf8_decode($CampoIDMensagem))
	);
	#echo $cSQL;
	...
	$cSQL = sprintf("INSERT INTO controlemensagemfiliado (
							ID,
							IDUsuarioFiliado,
							IDMensagensFiliado,
							MensagemLida
	...
	$MsgExclusaoSucesso = utf8_encode("Usuários adicionados com sucesso!");
