...
$TotalAExcluir = "OR cadastroimagensmensagensfiliado.ID = '".FiltrarCampos($ArrayParaSeparar[$i])."' ";	

$SelectImagens = "SELECT cadastroimagensmensagensfiliado.ID,
...
WHERE cadastroimagensmensagensfiliado.ID  = ''
  ".$TotalAExcluir."";
...
$PastaDoArquivo = CAMINHO_RELATIVO_IMAGENS_MENSAGENS.$CampoPastaDeConteudo;
$ArquivoASerApagado = CAMINHO_RELATIVO_IMAGENS_MENSAGENS."".$CampoPastaDeConteudo."/".$BuscaMostrarImagensParaExclusao[1]["ImagemConteudo"];
#echo $ArquivoASerApagado;
	...
	$SqlDeleteImagens = "DELETE FROM ".BANCO.".cadastroimagensmensagensfiliado
			  WHERE cadastroimagensmensagensfiliado.ID = ''
			  ".$TotalAExcluir."
			  ";
	...
	echo "<script>AlterarConteudo('Ferramentas/AreaDoFiliado/Mensagens/InserirImagens.php','DivInserirImagem','CampoPastaDeConteudo=".$CampoPastaDeConteudo."');</script>";
