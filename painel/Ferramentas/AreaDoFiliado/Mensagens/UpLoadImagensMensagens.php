...
#NO AR
$PastaACriar = CAMINHO_RELATIVO_IMAGENS_MENSAGENS."/".$PastaDeConteudo."/";
...
// Validate file extension
	...
	if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$file_name)) {
		...
		$SQLInserirImagens = sprintf("INSERT INTO cadastroimagensmensagensfiliado(
					ID,									
					DataDeCadastroDaImagem,
					ImagemConteudoDaMensagem,									
