...
if (!isset($PastaDeConteudo)) $PastaDeConteudo = '';
if (!isset($Controle)) $Controle = '';
if($PastaDeConteudo != '' && $Controle != ''){
...
#NO AR
$PastaACriar = CAMINHO_RELATIVO_ANEXOS_MENSAGENS."/".$PastaDeConteudo."/";
...
// Settings
	...
	$max_file_size_in_bytes = 33147483647; // 2GB in bytes
	$extension_whitelist = array("doc", "zip", "DOC", "xls", "XLS", "pdf", "PDF");	// Allowed file extensions
...
// Validate file extension
	...
	if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$file_name)) {
		...
		$SQLInserirImagens = sprintf("INSERT INTO cadastroanexomensagensfiliado(
					ID,									
					DataDeCadastroDoAnexo,
					NomeDoAnexoDaMensagem,									
				...
				FiltrarCampos(mysql_real_escape_string(utf8_decode($PastaDeConteudo)))
				);
