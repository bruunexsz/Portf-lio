...
<div class="col-10 d-flex justify-content-center align-items-center">
    <h2>Ficha de Renovação de Atleta
</h2>
</div>
...
@if ($errors->any())
    ...
    @endif
    <form method="POST" action="{{ route('renovacao-de-atleta') }}">
        @csrf
        <div class="row mb-3">
            <div class="col-md-8">
        ...
        <div class="row mb-3 mt-4">
            <div class="col-md-6">
                <label for="NRenovacoes" class="form-label">Nº de Renovações</label>
                <input type="text" class="form-control" id="NRenovacoes" name="NRenovacoes">
            </div>
            <div class="col-md-6">
